...
pause(3)
s1 = serialport("COM9",115200);       % Windows

%s1 = serialport("/dev/cu.usbmodem143201",115200);        % MacOS
...
%{
    ...
    warn_string = ["1. Check if Serial Port ID is set correctly.",...
        ...
        "3. Only #define MATLABSerialPrint in Arduino code is enabled.",... 
        "4. Do not close the figure window while the program is running.",...
        "5. Click on the STOP button on the figure window to stop properly."];
